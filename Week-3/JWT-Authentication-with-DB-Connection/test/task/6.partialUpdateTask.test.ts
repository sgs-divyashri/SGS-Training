...
describe('POST /users/login', () => {
    ...
    it('PARTIAL UPDATE TASK - partial update with all correct detail with 200', async () => {
        const payload = {
            name: 'Divya',
            email: uniqueEmail(),
    ...
    it('PARTIAL UPDATE TASK - partial update with partial correct detail with 200', async () => {
        const payload = {
            name: 'Divya',
            email: uniqueEmail(),
            password: 'Divyaaa@Sheiii0315',
    ...
    it('PARTIAL UPDATE TASK - Invalid path with 404 not found error', async () => {
        const payload = {
            name: 'Divya',
            email: uniqueEmail(),
            password: 'Divyaaa@Sheiii0315',
    ...
    it('PARTIAL UPDATE TASK - 401 Unauthorized, missing bearer token', async () => {
        const payload = {
            name: 'Divya',
            email: uniqueEmail(),
            password: 'Divyaaa@Sheiii0315',
